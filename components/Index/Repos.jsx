            ...
            <div className="max-w-screen-lg mx-auto w-full">
                <div className="flex items-center space-x-3">
                    <div className="select-none w-10 h-10 flex items-center justify-center">
                        <i className="text-transparent bg-clip-text bg-gradient-to-br from-yellow-500 to-yellow-700 fab fa-github text-4xl" />
                    </div>
                        ...
                        <a href={__.html_url} target="_blank" key={index} className="bg-[#090909] hover:bg-[#101010] relative transition-all duration-200 flex flex-col rounded-lg py-4 px-5">
                            ...
                            <div className="flex items-center space-x-2 mt-1">
                                ...
                                <div className="flex items-center space-x-1.5">
                                    <h1>{__.owner?.login ?? 'voidnull'}</h1>
                                </div>
                            </div>
                            <ul className="mt-3">
                                <li className="text-sm">
                                    <i className="far fa-code text-center w-4 mr-1.5" /> {__.language ?? "Readme"}
                                </li>
                                <li className="text-sm">
