        ...
        <div className="w-full h-96 bg-cover overflow-hidden p-5">
            <div className="max-w-screen-lg mx-auto w-full h-full relative">
                ...
                <div className="w-full h-full flex items-center">
                    <div>
                        <h1 className="text-4xl text-white font-bold">Hi, I'm <span className="text-transparent font-bold bg-clip-text bg-gradient-to-br from-yellow-500 to-yellow-700">voidnull</span>.</h1>
                        <h1 className="text-4xl text-transparent font-bold bg-clip-text bg-gradient-to-br from-yellow-500 to-yellow-700">Full-Stack <span className="text-4xl text-white font-bold">Developer</span></h1>
                        <h1 className="text-4xl text-transparent font-bold bg-clip-text bg-gradient-to-br from-yellow-500 to-yellow-700">PolyGlot <span className="text-4xl text-white font-bold">Developer</span></h1>
                        <h3 className="text-zinc-400 mt-1 max-w-md">I live in Turkey and I'm a high school student. I am passionate about programming. Those who want to reach me can look at the contact section.</h3>
