            ...
            <div className="max-w-screen-lg mx-auto w-full">
                <div className="flex items-center space-x-3">
                    <div className="select-none w-10 h-10 flex items-center justify-center">
                        <i className="text-transparent bg-clip-text bg-gradient-to-br from-yellow-500 to-yellow-700 fas fa-circle-bookmark text-4xl" />
                    </div>
                ...
                <div className="gap-2 pt-5 w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                    {techs ? techs.map((tech, index) => (
                        <div key={index} className="bg-[#101010] hover:-translate-y-[3px] hover:bg-[#111111] transition-all duration-200 rounded-lg p-2 px-3 flex items-center justify-between">
