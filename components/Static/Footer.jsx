        ...
        <div className="w-full px-5 pb-5 pt-16">
            <div className="max-w-screen-lg mx-auto w-full">
                ...
                <div className="hidden sm:flex my-3 items-center justify-between">
                    <h1 className="text-white">Copyright &copy; 2022-{new Date().getFullYear()}</h1>
                    <h1 className="text-white">Developed with <i className="fa-solid fa-code fa-beat mx-0.5" /> by voidnull</h1>
                </div>
